...
plan: 01
subsystem: typeck
tags: [type-checker, stdlib, mir-lowering, arity-bug, int-to-string]

# Dependency graph
requires:
  - phase: 109
    provides: "Sqlite.execute runtime + type signatures"
provides:
...
affects: [110, 111, 112, 113]

# Tech tracking
tech-stack:
  added: []
  patterns: ["stdlib module function additions require both typeck signature and MIR map_builtin_name entry"]
