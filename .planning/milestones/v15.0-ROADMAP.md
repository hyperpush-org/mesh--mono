...
Plans:
- [x] 148-01-PLAN.md — Add mesh-slug dependency to mesher/mesh.toml and run meshpkg install
- [x] 148-02-PLAN.md — Import Slug.slugify in queries.mpl, integrate into insert_org, compile and verify
