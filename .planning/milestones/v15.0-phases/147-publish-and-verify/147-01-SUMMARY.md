...
- FOUND: compiler/meshpkg/src/publish.rs
- FOUND: compiler/meshc/src/discovery.rs
- FOUND: .planning/phases/147-publish-and-verify/147-01-SUMMARY.md
- FOUND commit a59cad39 (fix: include root-level .mpl files in tarball)
- FOUND commit 957eb9a1 (feat: extend discovery.rs for installed package resolution)
- FOUND commit d77a1021 (docs: complete fix tarball and discovery plan)
