...
- follow-on guidance that points at [`examples/todo-postgres/README.md`](https://github.com/hyperpush-org/hyperpush-mono/blob/main/examples/todo-postgres/README.md) for the serious shared/deployable starter and [`examples/todo-sqlite/README.md`](https://github.com/hyperpush-org/hyperpush-mono/blob/main/examples/todo-sqlite/README.md) for the honest local starter instead of internal proof fixtures
...
Inspect a running clustered app with the same operator order used by the scaffold and [`examples/todo-postgres/README.md`](https://github.com/hyperpush-org/hyperpush-mono/blob/main/examples/todo-postgres/README.md):
